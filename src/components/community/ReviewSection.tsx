  ...
  const [reviews] = useState<Review[]>([
    {
      ...
      rating: 5,
      comment:
        "Amazing gym with fantastic trainers! The community here is so supportive and motivating. I've achieved results I never thought possible.",
      date: "2024-01-15",
      helpful: 23,
    },
    {
      ...
      rating: 5,
      comment:
        "Best fitness decision I've ever made. The equipment is top-notch and the classes are incredible. Highly recommend!",
      date: "2024-01-10",
      helpful: 18,
    },
    {
      ...
      rating: 4,
      comment:
        "Great facility with excellent trainers. The only reason I'm giving 4 stars is because it can get crowded during peak hours.",
      date: "2024-01-08",
      helpful: 12,
    },
    {
      ...
      rating: 5,
      comment:
        "Transformed my life! Lost 30 pounds and gained so much confidence. The personal training sessions are worth every penny.",
      date: "2024-01-05",
      helpful: 31,
    },
    {
      ...
      rating: 5,
      comment:
        "Love the variety of classes and the supportive community. The yoga sessions are my favorite!",
      date: "2024-01-03",
      helpful: 15,
    },
    {
      ...
      rating: 4,
      comment:
        "Clean facility, professional staff, and great equipment. The nutrition coaching was a game-changer for me.",
      date: "2024-01-01",
      helpful: 8,
    },
  ]);
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          {filteredReviews.map((review, index) => (
            ...
            >
              ...
              <p className="dark:text-black mb-4 leading-relaxed">
                {review.comment}
              </p>

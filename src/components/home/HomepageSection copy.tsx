    ...
    <div className="BC">
        ...
        <div className="max-w-7xl mx-auto px-8">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            {[
              ...
              <div
                key={idx}
                className="bg-card rounded-2xl overflow-hidden shadow-xl hover:shadow-2xl transform hover:-translate-y-3 transition-all duration-300 cursor-pointer animate-on-scroll"
              >
        ...
        <div className="max-w-7xl mx-auto px-8">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
            {filteredClasses.map((cls) => (
              <div
                key={cls.id}
                className="bg-card rounded-xl p-6 shadow-lg hover:shadow-xl transform hover:-translate-y-2 transition-all animate-on-scroll"
              >
          ...
          <div className="grid md:grid-cols-3 gap-8">
            {[
              ...
              <div
                ...
                className={`bg-card rounded-2xl p-8 text-center shadow-xl hover:shadow-2xl transform hover:-translate-y-3 transition-all cursor-pointer animate-on-scroll ${
        ...
        <div className="max-w-7xl mx-auto px-8">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            {[
              {
                name: "Sarah Johnson",
                text: "Joining OMEGA was the best decision I made for my health. The trainers are incredible and the community is so supportive!",
              },
              {
                name: "Mike Chen",
                text: "The variety of classes keeps me motivated every day. I've never been stronger or healthier!",
              },
              {
                name: "Emma Davis",
              ...
              <div
                key={idx}
                className="bg-card rounded-2xl p-8 text-center shadow-xl animate-on-scroll"
              >
      ...
      <section className="py-20 bg-primary text-primary-foreground">
        <div className="max-w-4xl mx-auto px-8 text-center animate-on-scroll">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            ...
            <Link
              href="/community"
              className="px-8 py-4 border-2 border-primary-foreground text-primary-foreground rounded-full font-semibold hover:bg-primary-foreground hover:text-primary transition-all"
            >
              Join Community
            </Link>
          </div>
      ...
      <footer className="bg-primary text-primary-foreground py-12 text-center">
        <p className="opacity-80">
          © 2025 OMEGA Fitness. All rights reserved. | Transform Your Body,
          Transform Your Life.
        </p>
      </footer>
    </div>
